      ...
      <div className="container relative flex items-center justify-between px-4 py-4 mx-auto">
        ...
        <div className="flex-shrink-0">
          <NavLink to="/" className="flex items-center space-x-2">
            ...
            <span className="text-xl font-extrabold text-blue-600">Tripvia</span>
          </NavLink>
        </div>

        {/* Center Navigation */}
        <nav className="absolute hidden space-x-8 text-sm font-medium text-gray-700 -translate-x-1/2 md:flex left-1/2">
          ...
          {isAuthenticated ? (
            <div className="relative" ref={dropdownRef}>
              <button
                ...
                className="flex items-center gap-2 px-3 py-2 text-gray-700 transition bg-white rounded-full shadow-sm hover:shadow-md"
              >
                ...
                <div className="absolute right-0 w-56 mt-2 bg-white shadow-lg rounded-xl animate-fade-down">
                  ...
                  <div className="flex flex-col py-2">
                    <NavLink to="/my-trips" className="flex items-center gap-2 px-4 py-2 text-gray-700 hover:bg-gray-100">
                      <FaSuitcaseRolling className="text-blue-500" /> My Trips
                    </NavLink>
            ...
            <>
              <NavLink to="/login" className="hidden font-medium text-blue-600 md:inline-block hover:underline">
                Login
              </NavLink>
              <NavLink to="/register" className="hidden px-5 py-2 text-white bg-blue-600 md:inline-block rounded-xl hover:bg-blue-700">
                Sign Up
              </NavLink>
              {/* Mobile Login Button */}
